      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview"><a href="downloads">
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td>01</td>
                      <td><img src="${pageContext.request.contextPath}/pages/images/jdk.png" alt="JBK Download" style="height: 40px; padding-left: 7px;"></td>  
                    ...
                    <tr>
                      <td>02</td>
                      <td><img src="${pageContext.request.contextPath}/pages/images/selenium.png" alt="JBK Download" style="height: 40px"></td>  
                      ...
                      <td></td>
                      <td></td>
                      <td><a href="${pageContext.request.contextPath}/downloads/selenium-server-standalone-2.52.0.jar" download>
                        <span class="label label-success">2.52.0</span>
                        <a href="${pageContext.request.contextPath}/downloads/selenium-server-standalone-3.9.0.jar" download>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <td><a href="${pageContext.request.contextPath}/downloads/selenium-java-2.46.0-srcs.jar" download>
                    ...
                    <tr>
                      <td>04</td>
                      <td><img src="${pageContext.request.contextPath}/pages/images/chrome.png" alt="JBK Download" style="height: 40px"></td>  
                      <td>Google Chrome </td>
                      <td><span class="label label-info">76.0</span></td>
                      <td><a href="${pageContext.request.contextPath}/downloads/GoogleChromeStandaloneEnterprise.exe" download>
                        <span class="label label-success">32bit</span>
                      </a></td>
                      <td><a href="${pageContext.request.contextPath}/downloads/GoogleChromeStandaloneEnterprise64.exe" download>
                        <span class="label label-success">64bit</span>
                      </a></td>
                      <td></td>
                    ...
                    <tr>
                      <td>06</td>
                      <td><img src="${pageContext.request.contextPath}/pages/images/firefox.png" alt="JBK Download" style="height: 40px"></td>  
                     ...
                     <tr>
                      ...
                      <td><a href="${pageContext.request.contextPath}/downloads/geckodriver32bit.exe" download>
                        <span class="label label-success">32bit</span>
                      </a></td>
                      <td><a href="${pageContext.request.contextPath}/downloads/geckodriver64bit.exe" download>
                        <span class="label label-success">64bit</span>
                      </a></td>
                      <td></td>
