          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="list" modelAttribute="admin" method = "post" onsubmit="alert('User Added Successfully. You can not see added user.')"> 
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputPassword3"  class="col-sm-3 control-label">Username</label>
                      <div class="col-sm-4">
                        <input class="form-control" name="username" required id="username" placeholder="Username" type="text">
                      </div>
                    </div>                    
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Mobile</label>
                      <div class="col-sm-4">
                        <input class="form-control" name="mobileNumber"  required id="mobile" placeholder="Mobile" type="number">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">Email</label>
                      <div class="col-sm-4">
                        <input class="form-control" name="email"  required id="email" placeholder="Email" type="email">
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control"name="course"  required id="course" placeholder="Java/J2EE" type="text">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" name="password"  required id="password" placeholder="Password" type="password">
                      </div>
                    </div>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="list"><span class="btn btn-default pull-right" style="width:150px;">Cancel</span></a>                   
                  </div><!-- /.box-footer -->
                </form>
              </div><!-- /.box -->
